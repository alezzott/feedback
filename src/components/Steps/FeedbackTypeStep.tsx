...
interface FeedbackTypeStepProps {
    onFeedbackTypeForm: (type: FeedbackType) => void
}

export function FeedbackTypeStep({ onFeedbackTypeForm }: FeedbackTypeStepProps) {
    return (
        <>
            <header>
                ...
                {Object.entries(feedbackTypes).map(([key, value]) => {
                    return (
                        <button
                            ...
                            onClick={() => onFeedbackTypeForm(key as FeedbackType)}
                            type="button"
                        >
